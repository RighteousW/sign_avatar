...
if __name__ == "__main__":
    ...
    save_full_model(model, gloss_vocab, text_vocab, config, save_dir="gloss2text_final")

    print("\n" + "=" * 60)
    print("TRAINING COMPLETE!")
    print("=" * 60)
    print("\nSaved models:")
    print("  - best_model.pth (lowest validation loss)")
    print("  - gloss2text_best_bleu/ (highest BLEU score)")
    print("  - gloss2text_final/ (final epoch)")
    print("\nTo use the trained model:")
    print(
        "  model, gloss_vocab, text_vocab, config = load_full_model('gloss2text_best_bleu', device)"
    )
    print(
